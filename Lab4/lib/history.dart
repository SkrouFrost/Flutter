...
class _MyListItem extends StatelessWidget {
  ...
  Widget poem_button(idpush, id, context) {
    return RaisedButton(
      onPressed: () {Navigator.push(idpush, MaterialPageRoute(builder: (idpush) => VirshPage()),); Glob.nupls=id;},
      elevation: 0.0,
        ...
        child: Row(children: [
          Container(
              child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                poem_button(context, item.id, item.name),
                Divider(
                  height: 1,
                  color: Colors.orange[50],
                )
